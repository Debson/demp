...
namespace mdEngine
{
	...
	public:
		...
		Shader(const GLchar* vertexPath, const GLchar* fragmentPath, const GLchar* gemoetryPath);
		Shader();

		static Shader* VertFrag(const GLchar* vertexPath, const GLchar* fragmentPath);
		static Shader* VertFragGeo(const GLchar* vertexPath, const GLchar* fragmentPath, const GLchar* gemoetryPath);

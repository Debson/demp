...
namespace mdEngine
{
	...
	Shader* Shader::VertFrag(const GLchar* vertexPath, const GLchar* fragmentPath)
	{
		Shader* s = new Shader();
	...
	Shader* Shader::VertFragGeo(const GLchar* vertexPath, const GLchar* fragmentPath, const GLchar* geometryPath)
	{
		Shader* s = new Shader();
